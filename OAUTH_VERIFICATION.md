...
DocTagger uses this scope only in the Google Doc where the user invokes the
...
DocTagger uses spreadsheet access to create a registry Sheet or open the
...
DocTagger uses this scope to add its menu and display the sidebar and help
...
2. Install/open DocTagger and show the complete OAuth consent screen in
